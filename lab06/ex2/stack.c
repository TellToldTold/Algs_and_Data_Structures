 ...
 */
stack_tt *stack_init(int size)
{
    stack_tt *sp;

  sp = (stack_tt *)util_malloc(sizeof(stack_tt));
  sp->size = size;
  sp->index = 0;
 ...
 */
int stack_push(stack_tt *sp, void *data)
{
 ...
 */
int stack_pop(stack_tt *sp, void **data_ptr)
{
 ...
 */
void stack_print(FILE *fp, stack_tt *sp, void (*print)(FILE *, void *))
{
  int i;
 ...
 */
void stack_dispose(stack_tt *sp, void (*quit)(void *))
{
  int i;
